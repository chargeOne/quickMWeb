...
require.config({
    ...
    paths: {
        ...
        "appConfig":"project/src/publish_rent/app/appConfig",
        //"appConfig":"project/src/publish_rent/app/appConfig2",
...
require(["project/src/publish_rent/app/appPages"], function (project) {
    ////console.log(project)
});
