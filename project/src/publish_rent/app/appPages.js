            ...
            var app = function () {
                ...
                var init = function () {
                    ...
                    setTimeout(function(){
                        ...
                        //App.global.user_clone=App.global.user;
                        ...
                        if(param==""||!param){//如果地址栏url无参
                            Mobilebone.ajax({
                                url: "publish_rent/"+ryan.syswin.config.pageList[0]+".html",
                                success: function() {
                                }
                            });
                        }
                ...
                return{
                    ...
                    //(!添加模块必改!)
                    fabuchuzu_bt:function(){
                        return{
                            init:function(callback){
                                //App.page.init('fabuchuzu_bt',callback);
                                /////Mobilebone.classAnimation = "slide";
                            },
                            update:function(callback){
                                App.page.update('fabuchuzu_bt',callback);
                            },
                            leave:function(callback){
                                App.page.leave('fabuchuzu_bt',callback);
                            }
                        }
                    },
                    fabuchuzu_xt:function(){
                        return{
                            init:function(callback){
                                //App.page.init('fabuchuzu_xt',callback);
                                /////Mobilebone.classAnimation = "slide";
                            },
                            update:function(callback){
                                App.page.update('fabuchuzu_xt',callback);
                            },
                            leave:function(callback){
                                App.page.leave('fabuchuzu_xt',callback);
                            }
                        }
                    },
                   ...
                   chaoxiang:function(){
                    ...
                    pianqu:function(){
                        return{
                            ...
                            update:function(callback){
                                ...
                                var area = App.global.user.getTempData("fabuchuzu_bt","xingzhengqu");
                                var area_id = "";
                                if(area == undefined){
                                    App.loadPage("fabuchuzu_bt");
                                }else{
                    ...
                    fangwupeitao:function(){
                        return{
                            init:function(){
                                /////Mobilebone.classAnimation = "slide";
                            },
                            update:function(callback){
                                App.page.update('fangwupeitao',callback,"r=Rent/Supporting");
                            },
                            leave:function(callback){
                              ///  App.page.leave('fangwupeitao',callback);
                            }
                        }
                    },
                    fangyuanbiaoqian:function(){
                        return{
                            ...
                            update:function(callback){
                                App.page.update('fangyuanbiaoqian',callback,"r=rent/Tags");
                            },
                            leave:function(callback){
                    ...
                    huxing_shi: function () {
                        return{
                            ...
                            update: function (callback) {
                                App.page.update('huxing_shi', callback);
                            },
                            leave: function (callback) {
                    ...
                    huxing_ting: function () {
                        return{
                            init: function () {
                                /////Mobilebone.classAnimation = "slidedown";
                            },
                            update: function (callback) {
                                App.page.update('huxing_ting', callback);
                            },
                            leave: function (callback) {
                    ...
                    huxing_wei: function () {
                        return{
                            ...
                            update: function (callback) {
                                App.page.update('huxing_wei', callback);
                            },
                            leave: function (callback) {
                    ...
                    fukuanfangshi:function(){
                        return{
                            init: function () {
                               // /////Mobilebone.classAnimation = "slide";
                            },
                            update: function (callback) {
                                App.page.update('fukuanfangshi', callback,"r=Rent/Payment");
                            },
                            leave: function (callback) {
                                /// App.page.leave('fukuanfangshi',callback);
                            }
                        }
                    },
                    gongnuanfangshi:function(){
                        return{
                            init: function () {
                                ///////Mobilebone.classAnimation = "slide";
                            },
                            update: function (callback) {
                                App.page.update('gongnuanfangshi', callback,"r=Rent/Heating");
                            },
                            leave: function (callback) {
                                /// App.page.leave('gongnuanfangshi',callback);
                            }
                        }
                    },
                    ruzhushijian:function(){
                        return{
                            init: function () {
                                ///////Mobilebone.classAnimation = "slide";
                            },
                            update: function (callback) {
                                App.page.update('ruzhushijian', callback,"r=rent/Checkintime");
								
                            },
                            leave: function (callback) {
                                /// App.page.leave('ruzhushijian',callback);
                            }
                        }
                    },
                    zuqi:function(){
                        return{
                            ...
                            update: function (callback) {
                                App.page.update('zuqi', callback,"r=Rent/Leaseterm");
                            },
                            leave: function (callback) {
                                /// App.page.leave('zuqi',callback);
                            }
                        }
                    },
                    //ryan++++++++++++++++++
                    baohanzujin:function(){
                        return{
                            init: function () {
                                /////Mobilebone.classAnimation = "slide";
                            },
                            update: function (callback) {
                                App.page.update('baohanzujin', callback,"r=Rent/Rentincontain");
                            },
                            leave: function (callback) {}
                        }
                    },
