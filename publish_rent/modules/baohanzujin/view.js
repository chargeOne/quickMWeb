...
define(['backbone', 'text!publish_rent/modules/baohanzujin/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        zsss_fun:function(e){
            ...
            that.selectCon="";
            that.selectId="";
            this.$selfPage.find("input[name='checkbox']").each(function(i) {
            ...
            //将户型信息写入localStorage
            ryan.syswin.app.global.user.setTempData("fabuchuzu_xt",this.$selfPage.attr("id"),this.selectCon+"&"+this.selectId);
