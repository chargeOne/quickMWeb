 ...
 *
 */
define(['backbone', 'text!publish_rent/modules/fangwuweizhi/view.html'], function (Backbone, ViewTemplate) {
    var byView = Backbone.View.extend({
        ...
        stickitData:function(){//将local storage中的缓存数据填入表格
            ...
            var xiaoqumingcheng=ryan.syswin.app.global.user.getTempData("fabuchuzu_bt","xiaoqumingcheng");
            ...
            var taofanghao=ryan.syswin.app.global.user.getTempData("fabuchuzu_bt","taofanghao");
