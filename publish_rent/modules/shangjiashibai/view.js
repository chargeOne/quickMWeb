...
define(['backbone', 'text!publish_rent/modules/shangjiashibai/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        llfyFun:function(){
            var fbcsid=ryan.syswin.app.global.user.getTempData("fabuchuzu_bt","fabuchuzuid");
            window.location.href=location.origin+"/index.php?r=rentinfo/index&id="+fbcsid;
        },
        jubaoFun:function(){
            var fbcsid=ryan.syswin.app.global.user.getTempData("fabuchuzu_bt","fabuchuzuid");
            window.location.href=location.origin+"/index.php?r=Rentinfo/jubao&id="+fbcsid;
        }
