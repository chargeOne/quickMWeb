...
* 行政区
*/
define(['backbone', 'text!publish_rent/modules/xingzhengqu/view.html'], function (Backbone, ViewTemplate) {
    var byView = Backbone.View.extend({
        ...
        li_subMenu:function( e){
            ...
            var tempData = ryan.syswin.app.global.user;
            //当行政区改变，清空片区
            var pre_xingzhengqu = tempData.getTempData("fabuchuzu_bt","xingzhengqu");
            if(pre_xingzhengqu && pre_xingzhengqu.split("&")[1] != xzq_id){
                tempData.setTempData("fabuchuzu_bt","pianqu","");
            }

            //将选定的行政区写入local Storage
            ryan.syswin.app.global.user.setTempData("fabuchuzu_bt","xingzhengqu",xzq_name+"&"+xzq_id);
