define(['backbone', 'text!publish_rent/modules/xinxifabuzerenxieyi/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        confirmFun:function(e){
            ryan.syswin.app.loadPage("fabuchuzu_xt","confirm");
        }
