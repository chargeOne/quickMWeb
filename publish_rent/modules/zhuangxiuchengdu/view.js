define(['backbone', 'text!publish_rent/modules/zhuangxiuchengdu/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        stickitData:function() {//将local storage中的缓存数据填入表格
            ...
            var pianqu=tempData.getTempData("fabuchuzu_xt","zhuangxiuchengdu");
        ...
        li_subMenu:function(e){
            ...
            //将片区名称写入localStorage
            ryan.syswin.app.global.user.setTempData("fabuchuzu_xt","zhuangxiuchengdu",zxcd_name+"&"+zxcd_id);
