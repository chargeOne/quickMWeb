define(['backbone', 'text!publish_sell/modules/fangyuanmiaoshu/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        stickitData:function() {//将local storage中的缓存数据填入表格
            ...
            var info=tempData.getTempData("fabuchushou_xt","fangyuanmiaoshu");
        ...
        fyms_fun:function(e){
            ...
            ryan.syswin.app.global.user.setTempData("fabuchushou_xt","fangyuanmiaoshu",info);
