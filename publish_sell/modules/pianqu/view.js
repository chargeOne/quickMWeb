...
*
*/
define(['backbone', 'text!publish_sell/modules/pianqu/view.html'], function (Backbone, ViewTemplate) {
    var byView = Backbone.View.extend({
        ...
        li_pianqu:function(e){
            ...
            //将片区名称写入localStorage
            ryan.syswin.app.global.user.setTempData("fabuchushou_bt","pianqu",pq_name+"&"+pq_id);

            clearTimeout(this.delayId);
            this.delayId = setTimeout(function(){ryan.syswin.app.loadPage("fabuchushou_bt")},800);
