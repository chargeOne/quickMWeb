define(['backbone', 'text!publish_sell/modules/tijiaochenggong/view.html'], function (Backbone, nearbyViewTemplate) {
    var nearbyView = Backbone.View.extend({
        ...
        fyyl:function(){
            ...
            var fbcsid=ryan.syswin.app.global.user.getTempData("fabuchushou_bt","fabuchushouid");//发布出租id
            //fbcsid = 56193;
            $ylBtn.off();
