...
*
*/
define(['backbone', 'text!publish_sell/modules/xiaoqumingcheng/view.html'], function (Backbone, ViewTemplate) {
            ...
            $input.one("click",function(e){//点击启动搜索框;
                ...
                appSearch.init($("#xiaoqumingcheng"),function(view,data){
                    ...
                    if(data.result=="success"){
                        //var $scroll=$("#xiaoqumingcheng").find(".mui-popover").find(".mui-scroll");
                        //$scroll.empty();
...
//                            moveItim(item.el);//移动搜索列表被点击项目
                            ...
                            ryan.syswin.app.global.user.setTempData("fabuchushou_bt","xiaoqumingcheng",xqmc+"&"+xqmc_id+"&"+xqmc_code);
                        ...
                        $scroll.find(".cyList").find("li").one("click",function(){
                            ryan.syswin.app.global.user.setTempData("fabuchushou_bt","xiaoqumingcheng",userInput);//将新增小区名称写入local storage
                            ryan.syswin.app.loadPage("fabuchushou_bt");
                        })
                    }
                    //appSearch.remove();
